package com.max.asr_plugin.asr;
...
public class AsrPlugin implements MethodChannel.MethodCallHandler {
    ...
    private static final String METHOD_NAME = "flutter_max_asr_plugin";
    private final Activity activity;
    private ResultStateful resultStateful;
    private AsrManager asrManager;

    public static void registerWith(PluginRegistry.Registrar registrar) {
        MethodChannel channel = new MethodChannel(registrar.messenger(), METHOD_NAME);
